...
(function($) {
    ...
    * ------------------------------------------------------ */
	...
	/* Add class for compatibility with wordpress
    * ---------------------------------------------------- */	
	$('.menu-item-has-children').addClass('has-children');
	$('.current_page_item').addClass('current');
	$('.page-numbers').addClass('pgn__num');
	$('.prev').addClass('pgn__prev');
	$('.next').addClass('pgn__next');
	$('.widgetlist ul').addClass('linklist');
	$('.comment-reply-title').addClass('h2');
